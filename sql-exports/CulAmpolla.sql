...
-- -----------------------------------------------------
-- Table `CulAmpolla-DB`.`DatosContacto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `CulAmpolla-DB`.`DatosContacto` (
  `telefono`  NOT NULL,
  `direccion`  NOT NULL,
  `numero`  NOT NULL,
  `piso`  NULL,
...
CREATE TABLE IF NOT EXISTS `CulAmpolla-DB`.`Empleado` (
  ...
  CONSTRAINT `fk_Empleado_Contacto1`
    ...
    REFERENCES `CulAmpolla-DB`.`DatosContacto` (`telefono`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
